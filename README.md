...
gunicorn app:app -w 8 -b 0.0.0.0:7860 --timeout 300 --keep-alive 30 --max-requests 2000 --max-requests-jitter 200 --worker-class gevent --worker-connections 200 --preload
```
